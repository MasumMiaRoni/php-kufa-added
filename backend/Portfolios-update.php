...
$description = $_POST['description'];
	...
	if ($_FILES['images']['name']) {
		...
		if ($allow) {
			if ($_FILES['images']['size'] < 500000){
				...
				$update = "UPDATE portfolios SET images = '$img_id'  title = '$title' ,description = '$description' WHERE id = '$id'";		
	...
	$update = "UPDATE portfolios SET title = '$title' ,description = '$description' WHERE id = '$id'";	
	$update_query = mysqli_query($db,$update);	
